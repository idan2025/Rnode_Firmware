#line 1 "/tmp/RNode_Firmware/Config.h"
...
#include "Boards.h"
    ...
    #elif MODEM == LR1110 && defined(NRF52840_XXAA)
        // Matches the SPIM peripheral instance used for the LR1110
        // by Seeed's official BSP, to avoid conflicting with any
        // other SPIM/TWIM peripheral assignment made by the core.
        SPIClass spiModem(NRF_SPIM3, pin_miso, pin_sclk, pin_mosi);
    #endif
